      ...
      <div className="w-full p-5 flex-1 xl:min-w-620">
        ...
        <Link to={`user-profile/${pinDetail.postedBy?._id}`} className="flex gap-2 mt-5 bg-white rounded-lg items-center" >
          <img 
            ...
            alt="user-profile"
            />
          <p className="font-black capitalize">{pinDetail.postedBy?.userName}</p>
        </Link>
        ...
        <div className="flex flex-wrap mt-6 gap-3">
          ...
          <button 
            type="button"
            className="bg-red-500 text-ehite rounded-full px-6 py-2 font-semibold text-base outline-none"
            onClick={addComment}>
